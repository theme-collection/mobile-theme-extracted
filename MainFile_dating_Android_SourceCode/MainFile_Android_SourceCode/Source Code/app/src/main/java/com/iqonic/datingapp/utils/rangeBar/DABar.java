...
public class DABar {
    ...
    public DABar(Context ctx,
        ...
        mRes = ctx.getResources();
         plain = Typeface.createFromAsset(ctx.getAssets(), ctx.getString(R.string.da_font_medium));
     ...
     */
    public float getNearestTickCoordinate(DAPinView thumb) {
     ...
     */
    public int getNearestTickIndex(DAPinView thumb) {
     ...
     *               View#onDraw()}
     */
    public void drawTicks(Canvas canvas, float pinRadius, DAPinView rightThumb) {
        drawTicks(canvas, pinRadius, rightThumb, null);
    }

    public void drawTicks(Canvas canvas, float pinRadius, DAPinView rightThumb, @Nullable DAPinView leftThumb) {
    ...
    private void drawTickLabel(Canvas canvas, final String label, float x, float pinRadius,
                               boolean first, boolean last, boolean isTop, DAPinView rightThumb, @Nullable DAPinView leftThumb) {
