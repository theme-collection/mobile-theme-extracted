...
class DAPinView extends View {
    ...
    private DAIRangeBarFormatter formatter;

    private float mMinPinFont = DARangeBar.DEFAULT_MIN_PIN_FONT_SP;

    private float mMaxPinFont = DARangeBar.DEFAULT_MAX_PIN_FONT_SP;
    ...
    public DAPinView(Context context) {
        super(context);
    }

    public void setFormatter(DAIRangeBarFormatter mFormatter) {
    ...
    public void init(Context ctx, float y, float pinRadiusDP, int pinColor, int textColor,
        ...
        mPin = ContextCompat.getDrawable(ctx, R.drawable.da_rotate);
