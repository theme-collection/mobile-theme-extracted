...
public class DAConnectingLine {
     ...
     */
    public DAConnectingLine(float y, float connectingLineWeight,
     ...
     */
    public void draw(Canvas canvas, DAPinView leftThumb, DAPinView rightThumb) {
     ...
     */
    public void draw(Canvas canvas, float leftMargin, DAPinView rightThumb) {
        paint.setShader(getLinearGradient(0, canvas.getWidth(), mY));
