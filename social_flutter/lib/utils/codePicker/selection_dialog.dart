  ...
  Widget build(BuildContext context) => CustomTheme(
        child: SimpleDialog(
          title: Column(
            ...
            children: <Widget>[
              text("Select Country Code", textColor: textPrimaryColor, fontSize: 16.0, fontFamily: fontSemibold),
              SizedBox(height: 8),
              TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(), fontSize: textSizeMedium, textColor: textPrimaryColor)),
                text(e.dialCode, fontSize: textSizeMedium, textColor: textPrimaryColor, fontFamily: fontSemibold),
              ],
            ),
          ),
        ],
