          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  _start == 0
                      ? text("Resend", textColor: grocery_textColorSecondary, fontSize: textSizeLargeMedium, fontFamily: fontMedium).paddingOnly(left: spacing_standard_new, bottom: spacing_standard_new).onTap(() {
                          startTimer();
                          _start = 9;
                          setState(() {});
                        })
