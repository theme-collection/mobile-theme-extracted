...
Widget scanMySpotCodeWidget(BuildContext context) {
  return Column(
    ...
    children: [
      ...
      20.height,
      Text("John Lewis", style: primaryTextStyle(size: 22, color: GPColorBlack)),
      15.height,
      ...
      FlatButton(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              "Open scanner",
              style: primaryTextStyle(color: grey, size: 14, weight: FontWeight.bold),
              textAlign: TextAlign.center,
            ).expand(),
          ],
        ),
...
Widget qrScannerWidget() {
  return Column(
    ...
    children: [
      ...
      30.height,
      Text("Lia Smith", style: primaryTextStyle(size: 18, color: GPColorBlack, weight: FontWeight.bold)),
      15.height,
      Text("liasmith@epay.com", style: primaryTextStyle(size: 13, color: GPColorBlack)),
      ...
      FlatButton(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.qr_code_scanner, color: grey),
            Text("Open scanner", style: primaryTextStyle(color: grey, size: 14, weight: FontWeight.bold), textAlign: TextAlign.center).expand(),
          ],
        ),
      ).paddingOnly(left: 60, right: 60),
    ],
