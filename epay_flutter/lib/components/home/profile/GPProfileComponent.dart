        ...
        actions: [
          PopupMenuButton(
            ...
            itemBuilder: (BuildContext context) {
              ...
              list.add(
                PopupMenuItem(child: Text("Referral code", style: TextStyle(color: GPColorBlack)), value: 1),
              );
              return list;
            },
          )
      ...
      body: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(image: DecorationImage(image: AssetImage(GP_profile_bg), fit: BoxFit.cover)),
            height: 160,
            width: context.width(),
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text("John Lewis", style: primaryTextStyle(size: 18, color: GPColorBlack, weight: FontWeight.bold)),
                    5.height,
                    Text("+91 389855849", style: primaryTextStyle(size: 14, color: GPColorBlack)),
                    5.height,
                    Text("liasmith.epay@com", style: primaryTextStyle(size: 14, color: GPColorBlack)),
                    30.height,
                    Row(
                      children: [
                ...
                Hero(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Stack(
                      children: [
                        CircleAvatar(radius: 40, backgroundImage: AssetImage(GPAY_user)),
                        Positioned(
                          bottom: 0,
                          right: 0,
                          child: Container(
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("EPay Bank **** 1111", style: primaryTextStyle(size: 14, color: Colors.black87, weight: FontWeight.bold)),
                        5.height,
                        Row(
                          children: [
          ...
          Container(
            ...
            decoration: boxDecorationWithRoundedCorners(
              ...
              boxShadow: [
                BoxShadow(color: Colors.grey, blurRadius: 2.0, offset: Offset(0.0, 0.10)),
              ],
            ),
