      ...
      body: Column(
        children: [
          _showLockScreen(
            context,
            opaque: false,
            circleUIConfig: CircleUIConfig(borderColor: Colors.white, fillColor: Colors.white, circleSize: 20),
            keyboardUIConfig: KeyboardUIConfig(digitBorderWidth: 2, primaryColor: Colors.white),
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) => PasscodeScreen(
          ...
          deleteButton: Text('Delete', style: TextStyle(fontSize: 16, color: Colors.white), semanticsLabel: 'Delete'),
  ...
  _showRestoreDialog(VoidCallback onAccepted) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Reset passcode", style: const TextStyle(color: Colors.black87)),
          content: Text("Passcode reset is a non-secure operation!\n\nConsider removing all user data if this action performed.", style: const TextStyle(color: Colors.black87)),
          actions: <Widget>[
