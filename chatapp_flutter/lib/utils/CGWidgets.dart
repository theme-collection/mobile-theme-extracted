...
class SettingWidget extends StatefulWidget {
  ...
  final padding;
  SettingWidget({this.icon, this.title, this.subtitle, this.onTap, this.padding});
...
class _SettingWidgetState extends State<SettingWidget> {
  ...
  Widget build(BuildContext context) {
    return (widget.subtitle == null)
        ? ListTile(
            contentPadding: widget.padding ?? EdgeInsets.symmetric(horizontal: 16.0, vertical: 0.0),
            leading: widget.icon != null ? Container(padding: EdgeInsets.all(8.0), child: Icon(widget.icon, color: getColorFromHex('#075E54'))) : null,
