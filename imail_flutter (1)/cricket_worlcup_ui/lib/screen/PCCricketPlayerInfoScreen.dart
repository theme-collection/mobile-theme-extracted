...
import 'package:cricket_worlcup_ui/model/PCPlayerInfoData.dart';
...
class _PCCricketPlayerInfoScreenState extends State<PCCricketPlayerInfoScreen> {
  ...
  init() async {
    String json = await rootBundle.loadString('assets/PlayerInfo.json');
                              ...
                              children: <Widget>[
                                Stack(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(height: 30, width: 30, decoration: PCboxDecoration(radius: 20.0, bgColor: Cricket_white, showShadow: true), child: Image.asset(Cricket_ic_batsman, height: 20, width: 20, fit: BoxFit.fill).paddingAll(4))
                                  ],
                                )
                              ],
                            ),
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.matches}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.innings}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.runs}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.highestScore}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.batAverage}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.batStrikeRate}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.hundreds}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.fifties}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.sixes}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.fours}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                        ...
                        Column(
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                Text("Innings", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontRegular)).paddingOnly(left: 8, top: 4, bottom: 4),
                                Text("${cricketPlayerInfoData.odiStats!.bowlInnings}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.wicketsTaken}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.economy}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.fiveWicket}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.fourWicket}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.maidens}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text("${cricketPlayerInfoData.odiStats!.bowlAverage}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8, right: 8, top: 4, bottom: 4),
                              ],
                            ),
                            Divider()
                          ],
