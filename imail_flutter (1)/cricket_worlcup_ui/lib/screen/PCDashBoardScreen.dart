              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) => GestureDetector(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(gradient: LinearGradient(begin: Alignment.topRight, end: Alignment.bottomLeft, colors: [Cricket_Gradient_color2.withOpacity(0.99999999), Cricket_Gradient_color1])),
                        width: 375,
                        child: Column(
                          children: <Widget>[
                            10.height,
