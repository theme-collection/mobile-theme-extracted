...
import 'package:cricket_worlcup_ui/model/PCCommentaryInProgressData.dart';
...
import 'package:cricket_worlcup_ui/screen/PCCricketScoreCardScreen.dart';
...
class _PCCricketMatchDetailScreenState extends State<PCCricketMatchDetailScreen> {
  ...
  init() async {
    String json1 = await rootBundle.loadString('assets/CommentaryInProgress.json');
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  Text("${getTeamName(widget.team1)} vs ${getTeamName(widget.team2)}", style: primaryTextStyle(color: Cricket_white, size: 18, fontFamily: fontMedium)).paddingOnly(left: 16, right: 8.0),
                                ],
                              ),
                                    ...
                                    children: <Widget>[
                                      Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Text(cricketCommentaryInProgressData.bat_team!.name!, style: primaryTextStyle(color: Cricket_white, size: 18, fontFamily: fontMedium)).paddingOnly(left: 24, top: 4),
                                        ],
                                      ),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Divider(),
                                Text("Last Wkt: ${cricketCommentaryInProgressData.last_wkt_name}(${cricketCommentaryInProgressData.last_wkt_score})", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontRegular))
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                  width: 25,
                                  height: 25,
                                  decoration: PCboxDecoration(radius: 15.0, bgColor: commLineModel[index].evt == "six" || commLineModel[index].evt == "four" ? Cricket_Primary : Cricket_Gradient_color1),
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[Text(getTeamName(widget.team1), style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontRegular)), Icon(Icons.keyboard_arrow_right, size: 30)],
                        ).onTap(() {
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[Text(getTeamName(widget.team2), style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontRegular)), Icon(Icons.keyboard_arrow_right, size: 30)],
                        ).onTap(() {
