...
import 'package:cricket_worlcup_ui/model/PCCommentaryPreviewData.dart';
...
class _PCCricketMatchInPreviewScreenState extends State<PCCricketMatchInPreviewScreen> {
  ...
  init() async {
    String json = await rootBundle.loadString('assets/CommentaryPreview.json');
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("${getTeamName(widget.team1)} vs ${getTeamName(widget.team2)}", style: primaryTextStyle(color: Cricket_white, size: 18, fontFamily: fontMedium)).paddingOnly(left: 16, right: 8, top: 28.0),
                          ],
                        ),
