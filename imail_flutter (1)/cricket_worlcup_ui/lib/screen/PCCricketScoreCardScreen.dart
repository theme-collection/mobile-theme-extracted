...
import 'package:cricket_worlcup_ui/model/PCScoreCardData.dart';
import 'package:cricket_worlcup_ui/model/PCSummaryData.dart';
import 'package:cricket_worlcup_ui/screen/PCCricketPlayerInfoScreen.dart';
...
class _PCCricketScoreCardScreenState extends State<PCCricketScoreCardScreen> {
  ...
  init() async {
    String json = await rootBundle.loadString('assets/scorecard.json');
    cricketScoreCardData = PCScoreCardData.fromJson(jsonDecode(json));
    String json2 = await rootBundle.loadString('assets/Summary.json');
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text((int.parse(batsmenModel[index].r!) / int.parse(batsmenModel[index].b!) * 100).toStringAsFixed(2).toString(), style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium))
                                        .expand(),
                                  ],
                                ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text("T${cricketScoreCardData!.innings![widget.index!].extras!.t}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 4).expand(),
                          Text("b${cricketScoreCardData!.innings![widget.index!].extras!.b}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 4).expand(),
                          Text("lb${cricketScoreCardData!.innings![widget.index!].extras!.lb}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 4).expand(),
                          Text("w${cricketScoreCardData!.innings![widget.index!].extras!.wd}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 4).expand(),
                          Text("nb${cricketScoreCardData!.innings![widget.index!].extras!.nb}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 4).expand(),
                          Text("p${cricketScoreCardData!.innings![widget.index!].extras!.p}", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(left: 8).expand(),
                        ],
                      ).paddingOnly(right: 4),
                    ),
                    Divider(),
