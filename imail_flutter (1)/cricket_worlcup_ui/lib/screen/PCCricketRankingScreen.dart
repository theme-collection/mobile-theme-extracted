...
import 'package:cricket_worlcup_ui/model/PCRanking.dart';
...
class _PCCricketRankingScreenState extends State<PCCricketRankingScreen> {
  ...
  init() async {
    String json = await rootBundle.loadString('assets/ranking.json');
                        ...
                        return Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Flexible(
                                flex: 1,
                                child: Text(odiBatsmanList[index].rating!, style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(top: 8, right: 16, bottom: 8),
                              )
                            ],
                          ),
                        );
                        ...
                        return Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Flexible(
                                flex: 1,
                                child: Text(odiBowlingList[index].rating!, style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(top: 8, right: 16, bottom: 8),
                              )
                            ],
                          ),
                        );
                        ...
                        return Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: <Widget>[
                                            Text(odiAllRounderList[index].name!, style: primaryTextStyle(color: Cricket_textColorPrimary, size: 14, fontFamily: fontRegular)).paddingOnly(top: 16, left: 8),
                              ...
                              Flexible(
                                flex: 1,
                                child: Text(odiAllRounderList[index].rating!, style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(top: 8, right: 16, bottom: 8),
                              )
                            ],
                          ),
                        );
                    ...
                    Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Flexible(flex: 1, child: Text("Ratting", style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(top: 8, left: 8, right: 16, bottom: 8)),
                        ...
                        return Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Flexible(
                                flex: 1,
                                child: Text(odiTeamList[index].rating!, style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium), textAlign: TextAlign.end).paddingOnly(top: 8, bottom: 8),
                              ),
                              Flexible(
                                flex: 1,
                                child: Text(odiTeamList[index].points!, style: primaryTextStyle(color: Cricket_textColorPrimary, size: 16, fontFamily: fontMedium)).paddingOnly(top: 8, right: 16, bottom: 8),
                              )
                            ],
                          ),
                        );
