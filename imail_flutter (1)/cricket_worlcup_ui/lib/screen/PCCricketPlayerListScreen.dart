...
class _PCCricketPlayerListScreenState extends State<PCCricketPlayerListScreen> {
  ...
  init() async {
    String json = await rootBundle.loadString('assets/Cricket_team.json');
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return GestureDetector(
              ...
              child: Container(
                child: Row(
                  children: <Widget>[
                    commonCacheImageWidget(Cricket_ic_profile, context.width() * 0.15, width: context.width() * 0.15, fit: BoxFit.fill).cornerRadiusWithClipRRect(10.0).paddingOnly(top: 8, left: 8, bottom: 8),
                    Container(
