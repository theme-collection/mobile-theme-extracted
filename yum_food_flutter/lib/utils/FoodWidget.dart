...
import 'package:yum_food_flutter/screen/FoodAddAddress.dart';
...
Widget search(BuildContext context) {
  return Container(
    ...
    child: RichText(
      text: TextSpan(
        children: [
          WidgetSpan(child: Padding(padding: const EdgeInsets.only(right: 8), child: Icon(Icons.search, color: grey, size: 18))),
