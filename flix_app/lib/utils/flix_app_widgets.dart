...
import 'package:flix_app/screens/flix_movie_detail_screen.dart';
import 'package:flix_app/utils/flix_app_constant.dart';
import 'package:flix_app/utils/flix_percent_indicator.dart';
...
Widget headingWidViewAll(BuildContext context, var titleText, callback) {
  return Row(
    children: <Widget>[Expanded(child: headingText(context, titleText)), InkWell(onTap: callback, child: itemSubTitle(context, "View More", fontsize: ts_medium, fontFamily: font_medium, colorThird: true).paddingAll(spacing_control_half))],
  );
}
...
Widget formField(
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      ...
      suffixIcon: isPassword && isPasswordVisible ? GestureDetector(onTap: suffixIconSelector, child: Icon(suffixIcon, color: muvi_colorPrimary, size: 20)) : Icon(suffixIcon, color: muvi_colorPrimary, size: 20),
...
Widget placeholderWidget() => Image.asset('images/muvi/images/grey.jpg', fit: BoxFit.cover);
